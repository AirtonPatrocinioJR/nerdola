...
<?php $__env->startSection('title', 'Gerar QR Code - Nerdola Bank'); ?>
...
<div class="max-w-md mx-auto px-4 py-6 pb-24">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form method="POST" action="<?php echo e(route('client.qrcode.generate')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
