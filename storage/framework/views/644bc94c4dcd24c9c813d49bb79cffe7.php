...
<?php $__env->startSection('title', 'Transferir - Nerdola Bank'); ?>
...
<div class="max-w-md mx-auto px-4 py-6 pb-24">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="mb-4 p-3 bg-gray-50 rounded-md">
            ...
            <p class="text-2xl font-bold text-blue-600"><?php echo e(number_format(auth()->user()->wallet->balance, 2, ',', '.')); ?> NDL</p>
        </div>

        <form method="POST" action="<?php echo e(route('client.transfer')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
