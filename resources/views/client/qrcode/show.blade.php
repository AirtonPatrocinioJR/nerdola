...
@section('title', 'QR Code - Nerdola Bank')

@section('content')
<div class="max-w-md mx-auto px-4 py-6 pb-24">
    <div class="bg-white rounded-lg shadow-md p-6 text-center">
        <h2 class="text-xl font-bold mb-4">QR Code de Recebimento</h2>
        ...
        <a href="{{ route('client.dashboard') }}" class="block mt-6 text-blue-600 hover:text-blue-700">
            Voltar ao Dashboard
        </a>
    </div>
</div>
