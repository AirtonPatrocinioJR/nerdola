...
@section('title', 'Gerar QR Code de Depósito - Nerdola Bank')
...
<div class="max-w-2xl mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <h2 class="text-xl font-bold mb-6">Gerar QR Code de Depósito</h2>

        <form method="POST" action="{{ route('admin.deposits.qrcode.generate') }}" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" id="description" name="description"
                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                       placeholder="Ex: Depósito de evento">
            </div>
